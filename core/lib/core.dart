...
export 'package:core/src/domain/entities/shopping_entity.dart';
export 'package:core/src/domain/entities/token_entity.dart';
export 'package:core/src/domain/entities/user_entity.dart';
export 'package:core/src/domain/entities/user_preferences_entity.dart';
...
export 'package:core/src/infra/models/shopping_model.dart.dart';
export 'package:core/src/infra/models/token_model.dart';
export 'package:core/src/infra/models/user_model.dart';
export 'package:core/src/infra/models/user_preferences_model.dart';
