...
abstract class INavigationArgumentsDriver {
  /// It retrieves parameters after consulting a dynamic route. If it is
  /// not a dynamic route the object will be an empty Map.
  ...
  /// itself. ex: Navigation.to.navigate('/product', arguments: Products());
  ...
  /// empty string. If a key occurs more than once in the query string,
  /// it is mapped to an arbitrary choice of possible value.
  /// The [queryParametersAll] getter can provide a map that
