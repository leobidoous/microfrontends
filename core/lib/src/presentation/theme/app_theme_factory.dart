...
import 'base/color/foreground/dark_foreground.dart';
import 'base/color/foreground/light_foreground.dart';
import 'base/typography/typography_builder.dart';
...
extension ColorSchemeExtension on ColorScheme {
  ...
  // DM.get<AppColorScheme>().colorPrimaryDarkest;

  // /// colorPrimaryDark
  // Color get colorPrimaryDark =>
  // DM.get<AppColorScheme>().colorPrimaryDark;

  // /// colorPrimaryMedium
  // Color get colorPrimaryMedium =>
  // DM.get<AppColorScheme>().colorPrimaryMedium;

  // /// colorPrimaryLight
  // Color get colorPrimaryLight =>
  // DM.get<AppColorScheme>().colorPrimaryLight;
  ...
  // DM.get<AppColorScheme>().colorSecondaryDark;
  ...
  // DM.get<AppColorScheme>().colorSecondaryLight;
  ...
  // DM.get<AppColorScheme>().colorTertiaryMedium;

  // /// colorTertiaryLight
  // Color get colorTertiaryLight =>
  // DM.get<AppColorScheme>().colorTertiaryLight;
  ...
  // /// colorSystemTransparent
  // Color get colorSystemTransparent =>
  //     DM.get<AppColorScheme>().colorSystemTransparent;
  ...
  // DM.get<AppColorScheme>().gradientRedToDark;
